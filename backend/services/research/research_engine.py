...
class ResearchEngine:
    ...
    def investigate(self, request: ResearchRequest) -> ResearchResult:
        ...
        # Stage 6: Adaptive Primary Source Escalation
        ...
        # Stage 7: Diversity-Aware Deep Reading (6-10 sources)
        ...
        # Stage 8: Relevant Passage Extraction
        # Run on investigated items (full articles), and fallback for remaining ranked items
        ...
        # Stage 10: Grounded Finding Synthesis
        ...
        # Stage 11: Evidence Graph Construction
